...
public class YouTubeConnector {
    ...
    public static final String SHA1 = "63:95:9C:F4:69:C6:DB:22:DD:E1:A3:E4:29:95:A7:0F:F5:AF:51:43";

    //maximum results that should be downloaded via the YouTube data API at a time
    private static final long MAXRESULTS =25;//25; Acceptable values are 0 to 50, inclusive. The default value is 5.

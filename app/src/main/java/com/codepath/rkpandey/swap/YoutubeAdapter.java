...
public class YoutubeAdapter extends RecyclerView.Adapter<YoutubeAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public TextView video_title, video_description;// video_id,
...
//            video_id = (TextView) view.findViewById(R.id.video_id);
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.search_youtube_video_item, parent, false);
...
//        holder.video_id.setText("Video ID : "+singleVideo.getId()+" ");
        holder.video_title.setText((position+1)+". "+singleVideo.getTitle());
        ...
        holder.video_view.setOnClickListener(view -> {
            ...
            //creating a intent for Play_act class from this Activity
            //arguments needed are package context and the new Activity class
            Intent intent = new Intent(mContext, Play_act.class);
